...
const SHELL=['./','index.html','grownups.html','manifest.webmanifest','icons/icon-180.png','icons/icon-192.png','icons/icon-512.png','vendor/phaser.min.js',
  'src/main.js','src/worlds.js','src/core/ui.js','src/core/store.js','src/core/sfx.js','src/core/art.js','src/mech/index.js','src/space/facts.js','src/space/levels.js','src/math/gen.js','src/math/levels.js'];
